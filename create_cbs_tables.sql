...
DROP TABLE neighborhood_info;
DROP TABLE municipality_names;
DROP TABLE district_names;
DROP TABLE postcodes;

-- Create the neighborhood table and import the data
CREATE TABLE neighborhood(buurtcode2020 text, buurtnaam2020 text, GM_2020 text, GM2020 integer, GM_NAAM text, WK_2020 text, WK2020 integer, WK_NAAM text);
