...
\copy neighborhood(buurtcode2020, buurtnaam2020, GM_2020, GM2020, GM_NAAM, WK_2020, WK2020, WK_NAAM) FROM '/home/pi/RSL/Assignment_2/Input_Data/brt2020.csv' delimiter ';' CSV HEADER;
...
\copy municipality_names(Gemcode2020, Gemeentenaam2020) FROM '/home/pi/RSL/Assignment_2/Input_Data/gem2020.csv' delimiter ';' CSV HEADER;
...
\copy district_names(wijkcode2020, wijknaam2020) FROM '/home/pi/RSL/Assignment_2/Input_Data/wijk2020.csv' delimiter ';' CSV HEADER;
...
\copy postcodes(PC6, Buurt2020, Wijk2020, Gemeente2020) FROM '/home/pi/RSL/Assignment_2/Input_Data/pc6-gwb2020.csv' delimiter ';' CSV HEADER;
